    ...
    <View className="gap-2 pt-4">
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <Input
            ...
            icon={<Icon name={"idcard"} size={20} color="gray" />}
          />
        )}
      />
      <Controller
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <Input
            className={" w-full py-3 placeholder:text-slate-400 "}
            placeholder={"Grade and Section e.g. 11-A"}
            value={value}
            onChangeText={onChange}
            icon={<IconMaterialUi name={"grade"} size={20} color="gray" />}
          />
        )}
      />
      <Controller
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <Input
            ...
            value={value}
            onChangeText={onChange}
            icon={<Icon name={"phone"} size={20} color="gray" />}
          />
        )}
      />
      <Controller
