...
const CartSummary = ({ subtotal, deliveryFee, total }: CartSummaryProps) => {
  return (
    <View className="bg-white/90 p-4">
      ...
      <View className="flex-row justify-between mb-2">
        <Typo className="text-gray-600">Delivery Fee</Typo>
        <Typo className="text-gray-800 font-medium">₱{deliveryFee}</Typo>
      </View>
