...
const LoginProviderIcon = () => {
  return (
    <Animated.View entering={FadeInUp.delay(700).duration(500).damping(1).springify()} className="flex items-center px-5 gap-2">
      <Text className="text-2xl text-white">or</Text>
